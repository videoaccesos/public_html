		...
		public function enviar_notificaciones($intRegistroAccesoID){
									        ...
									        <div class="fluid">
									            <div class="encabezado_back">
									                   ...
									                   <div class="encabezado">
									                        ...
									                        <img src="http://www.videoaccesos.com/syscbctlmonitoreo/img/logo.png" alt="" style="margin-bottom:10px;">
									                      </a>
									                        <div class="derecha">
	        ...
	        $strmensaje .= 'Imagen registrada del evento: <br>
							<a href="http://www.videoaccesos.com/detalles_notificacion.php?img='.str_replace(".","%2e",$res['data']['imagen']).'">
							    <img src="http://www.videoaccesos.com/syscbctlmonitoreo/uploads/'.$res['data']['imagen'].'" alt="Imagén del evento!" class="img-polaroid" >
							</a><br>
