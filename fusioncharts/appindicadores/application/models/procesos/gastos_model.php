...
{
	public function guardar($intTipoGastoID, $intPrivadaID, $strDescripcion,$strComprobante,$dblTotal, $intTipoPagoID, $intGastoAutorizadoID){
	...
	public function filtroAutorizados($strBusqueda, $intNumRows, $intPos){
		...
		$this->db->select("G.gasto_id, G.tipo_gasto, G.privada_id, G.tipo_pago, P.descripcion AS privada,TG.gasto, G.descripcion_gasto,G.comprobante,FORMAT(G.total,2) AS total, (CASE G.tipo_pago WHEN 1 THEN 'Efectivo' WHEN 2 THEN 'Bancos' END ) AS tipopago, U.usuario, G.fecha", FALSE);
