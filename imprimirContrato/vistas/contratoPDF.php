...
$interfonExtra= $todosLosRegistros['interfon_extra'];
...
$extraInterfon="";
if ($extraClaveInterfon != "" && $extraTelefonoInterfon != "" && $interfonExtra == 1)
{
$extraInterfon= utf8_decode('Clave: ').$extraClaveInterfon.utf8_decode(' Teléfono: ').$extraTelefonoInterfon;
}
...
$pdf->Cell(190, 7, utf8_decode('Domicilio: ').$todosLosRegistros['calle'].' '.$todosLosRegistros['nro_casa'].' '.$todosLosRegistros['descripcion'], 1,0);
  $pdf->Ln(7);
$pdf->Cell(190, 7, utf8_decode('Teléfono Celular: ').$todosLosRegistros['telefono2'].utf8_decode('  Cve. Interfón: ').$interfon.utf8_decode(' Tel. Interfón: ').$telefonoInterfon, 1,0);
  $pdf->Ln(7);
$pdf->Cell(190, 7, utf8_decode('Teléfono Casa: ').$todosLosRegistros['telefono1'], 1,0);
  $pdf->Ln(7);
if ($extraInterfon != "")
{
$pdf->Cell(190, 7, utf8_decode('Extra Interfón: ').$extraInterfon, 1,0);
  $pdf->Ln(7);
}
...
if ($extraPrecioInterfon>0 && $interfonExtra == 1)
{
$pdf->Cell(30, 6, '', 0,0,'C');
$pdf->SetFont('Arial', 'B', 9);
$pdf->Cell(30, 6, '',0,0,'C');
