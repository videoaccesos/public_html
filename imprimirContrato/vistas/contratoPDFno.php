...
$tipoPago=$todosLosRegistros['tipo_pago'];
if ($tipoPago == 0)
{
$tipoPagoLetra="No Definido";
}
if ($tipoPago == 1)
{
...
$observaciones= $todosLosRegistros['observaciones'];
...
$pdf->Cell(150, 10, $nombre_privada, 0,0,'L');
...
$pdf->Cell(110, 6, utf8_decode('NÚMERO DE TARJETA (N/S)'), 1,0,'C');
...
$pdf->Cell(110, 6, $tarjeta1[0].' ('.$numeroSerie1.')', 1,0,'C');
if ($tipoTarjeta1[0]== "1")
{
...
{
$pdf->Cell(30, 6, '1', 1,0,'C');
$pdf->Cell(110, 6, $tarjeta2[0].' ('.$numeroSerie2.')', 1,0,'C');
if ($tipoTarjeta2[0]== "1")
{
...
{
$pdf->Cell(30, 6, '1', 1,0,'C');
$pdf->Cell(110, 6, $tarjeta3[0].' ('.$numeroSerie3.')', 1,0,'C');
if ($tipoTarjeta3[0]== "1")
{
...
{
$pdf->Cell(30, 6, '1', 1,0,'C');
$pdf->Cell(110, 6, $tarjeta4[0].' ('.$numeroSerie4.')', 1,0,'C');
if ($tipoTarjeta4[0]== "1")
{
...
{
$pdf->Cell(30, 6, '1', 1,0,'C');
$pdf->Cell(110, 6, $tarjeta5[0].' ('.$numeroSerie5.')', 1,0,'C');
if ($tipoTarjeta5[0]== "1")
{
...
$pdf->SetFont('Arial', 'B', 9);
$pdf->Cell(30, 6, '',0,0,'C');
$pdf->Cell(80, 6, 'Tipo de Pago:', 0,0,'R');
$pdf->Cell(50, 6, ''.$tipoPagoLetra.'',1,0,'C');
$pdf->Ln(10);
if ($observaciones != "")
{
$pdf->SetFont('Arial', '', 9);
$pdf->Cell(190, 5, utf8_decode('Observaciones:  '.$observaciones.''),1,0,'L');
$pdf->Ln(10);
}
$pdf->SetFont('Arial', 'B', 10);
...
$pdf->Ln(3);
$pdf->Cell(180, 5, utf8_decode('acceso instalado en la entrada del residencial '.$nombre_privada.'. Así mismo realizo las siguientes declaraciones:'),0,0,'L');
$pdf->Ln(3);
$pdf->Cell(180, 5, utf8_decode(''),0,0,'L');
$pdf->Ln(3);
$pdf->Cell(180, 5, utf8_decode('PRIMERA: En este acto me adhiero al contrato o acuerdo que celebró el comité de vecinos del residencial '.$nombre_privada.' y Accessbot Asistentes'),0,0,'L');
$pdf->Ln(3);
$pdf->Cell(180, 5, utf8_decode('Inteligentes SAS de CV, a quien en este documento se le denominará El Prestador. Para el suministro de equipo y prestación de servicio de teleportero,'),0,0,'L');
$pdf->Ln(3);
$pdf->Cell(180, 5, utf8_decode('este contrato me fue presentado para su lectura, así mismo reconozco que el prestador es arrendatario del equipo instalado en el acceso del residencial '),0,0,'L');
$pdf->Ln(3);
$pdf->Cell(180, 5, utf8_decode('conforme a las indicaciones del comité de vecinos que firman el contrato de servicio de asistencia de accesos en el residencial '.$nombre_privada),0,0,'L');
$pdf->Ln(3);
$pdf->Cell(180, 5, utf8_decode('y que dicho equipo no es propiedad del residencial ni forma parte de su patrimonio.'),0,0,'L');
$pdf->Ln(3);
$pdf->Cell(180, 5, utf8_decode('Los mantenimientos preventivos y correctivos serán realizados por  el arrendador  conforme a lo estipulado en el contrato. Las tarjeta proporcionadas'),0,0,'L');
$pdf->Ln(3);
$pdf->Cell(180, 5, utf8_decode('a los residentes para facilitar el acceso al residencial constituyen un instrumento autorizado y proporcionado  por el comité de vecinos del residencial'),0,0,'L');
$pdf->Ln(3);
$pdf->Cell(180, 5, utf8_decode('y tendrá validez únicamente durante la duración del contrato.'),0,0,'L');
$pdf->Ln(5);
$pdf->Cell(180, 5, utf8_decode('SEGUNDA: Entiendo que la compra de tarjetas en ningún momento obliga al Prestador a brindarme algún servicio, en particular y que el prestador'),0,0,'L');
$pdf->Ln(3);
$pdf->Cell(180, 5, utf8_decode('realizará su trabajo conforme a las instrucciones que el comité de vecinos le haga llegar oportunamente.'),0,0,'L');
$pdf->Ln(4);
$pdf->Cell(180, 5, utf8_decode('Esta tarjeta podrá ser activada para acceder al residencial, siempre y cuando lo autorice el comité de vecinos y podrá ser cancelada y/o suspendida'),0,0,'L');
$pdf->Ln(3);
...
$pdf->Ln(3);
$pdf->Cell(180, 5, utf8_decode('reporte podrá ser directamente en las oficinas de Accessbot Asistentes ubicadas en Blvd. Zapata 543 Pte. Loc. 5 de esta ciudad de Culiacán, Sinaloa.'),0,0,'L');
$pdf->Ln(5);
$pdf->Cell(180, 5, utf8_decode('CUARTA: En este acto autorizo a Accessbot Asistentes Inteligentes SAS de CV o a quien ellos designen a representarme ante las autoridades '),0,0,'L');
$pdf->Ln(3);
$pdf->Cell(180, 5, utf8_decode('de cualquier nivel de gobierno, exclusivamente en lo referente a acto o disputas relativos a la operación de control de acceso instalado y gestión de'),0,0,'L');
$pdf->Ln(3);
$pdf->Cell(180, 5, utf8_decode('servicios públicos al interior del residencial.'),0,0,'L');
$pdf->Ln(5);
...
$pdf->Ln(5);
$pdf->Cell(180, 5, utf8_decode('SEXTA: Reconozco que se me informa que puedo consultar integralmente el aviso de privacidad que protege mis datos personales, directamente en la'),0,0,'L');
$pdf->Ln(3);
$pdf->Cell(180, 5, utf8_decode('página web www.videoaccesos.com'),0,0,'L');
$pdf->Ln(5);
$pdf->Cell(180, 5, utf8_decode('SÉPTIMA: En caso de pérdida de la tarjeta se deberá de comprar una nueva al precio contratado.'),0,0,'L');
$pdf->Ln(12);
