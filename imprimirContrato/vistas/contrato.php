...
$domicilio= $calle.' '.$numeroCasa.' '.$privada;
?>
...
{
            echo "<td width='120'></td><td width='200'><a target='_blank' href='contratoPDFno.php' class='btn btn-danger'>Generar Contrato</a></td> <td width='200'><a target='_blank' href='../../syscbctlmonitoreo' class='btn btn-danger'>Regresar</a></td>";
}
if ($fechaVencimiento != "0000-00-00")
{
            echo "<td width='120'></td><td width='200'><a target='_blank' href='contratoPDF.php' class='btn btn-danger'>Generar Contrato</a></td> <td width='200'><a target='_blank' href='../../syscbctlmonitoreo' class='btn btn-danger'>Regresar</a></td>";
}
        ?>
        </tr>
    </table>
