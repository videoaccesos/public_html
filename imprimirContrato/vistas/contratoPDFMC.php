...
$pdf->Cell(190, 7, utf8_decode('Domicilio: ').$todosLosRegistros['calle'].' '.$todosLosRegistros['nro_casa'].' '.$todosLosRegistros['descripcion'], 1,0);
	$pdf->Ln(7);
$pdf->Cell(190, 7, utf8_decode('Teléfono Celular: ').$todosLosRegistros['telefono2'].utf8_decode('    Clave Interfón: ').$interfon.utf8_decode('    Teléfono Interfón: ').$telefonoInterfon, 1,0);
	$pdf->Ln(7);
...
$total = $precio1[0]+$precio2[0]+$precio3[0]+$precio4[0]+$precio5[0]+$totalSeguros-$descuento+$IVA;
