    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title"><i class="fa fa-plus"></i> Crear solicitud</h4>
	      </div>
...
<!-- 	      	<div class="form-group">
	        ...
	        <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="productName" placeholder="Nombre del solicitante" name="productName" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	    

	        <div class="form-group">
	        	<label for="quantity" class="col-sm-3 control-label">Telefono: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="quantity" placeholder="Telefono" name="quantity" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	        	 

	        <div class="form-group">
	        	<label for="rate" class="col-sm-3 control-label">Correo: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="rate" placeholder="Correo" name="rate" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	     	        
	        <div class="form-group">
	        	<label for="productStatus" class="col-sm-3 control-label">Municipio: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <select class="form-control" id="productStatus" name="productStatus">
				      	...
				      	<option value="3">Badiraguato</option>
				      	<option value="4">Concordia</option>
				      	<option value="5">Cosala</option>
				      	<option value="6">Culiacan</option>
				      	<option value="7">Choix</option>
				      	<option value="8">Elota</option>
				      	<option value="9">Escuinapa</option>
				      	<option value="10">El Fuerte</option>
				      	<option value="11">Guasave</option>
				      	<option value="12">Mazatlan</option>
				      	<option value="13">Mocorito</option>
				      	<option value="14">El Rosario</option>
				      	<option value="15">Salvador Alvarado</option>
				      	<option value="16">San Ignacio</option>
				      	<option value="17">Sinaloa</option>
				      	<option value="18">Navolato</option>
				      </select>
				    </div>
				    
	        </div> <!-- /form-group-->	    
	        <div class="form-group">
	        	<label for="brandName" class="col-sm-3 control-label">Petición: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				     	<input type="text" class="form-control" id="brandName" placeholder="Peticion" name="brandName" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	
	      	...
	      	<div class="div-result">
				  ...
				  <ul class="nav nav-tabs" role="tablist">
				   <!--  <li role="presentation" class="active"><a href="#photo" aria-controls="home" role="tab" data-toggle="tab">Imagen</a></li> -->
				    <li role="presentation"><a href="#productInfo" aria-controls="profile" role="tab" data-toggle="tab">Información de la solicitud</a></li>    
				  </ul>
...
<!-- 				    </div>
				    ...
				    <div role="tabpanel" class="tab-pane active" id="productInfo">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="editProductName" placeholder="Nombre del solicitante" name="editProductName" autocomplete="off">
						    </div>
			        </div> <!-- /form-group-->	    
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeProductModal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><i class="glyphicon glyphicon-trash"></i> Eliminar solicitud</h4>
      </div>
      <div class="modal-body">

      	<div class="removeProductMessages"></div>

        <p>¿Realmente deseas eliminar esta solicitud?</p>
      </div>
