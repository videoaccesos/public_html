...
<body>
    ...
    <img class='img-round' src='204x65.png' align="center" />
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">      
      ...
      <ul class="nav navbar-nav navbar-right">        
      	...
      	<li id="navDashboard"><a href="login.php"><i class="glyphicon glyphicon-list-alt"></i>  Inicio</a></li>        
...
<!--         <li id="navBrand"><a href="brand.php"><i class="glyphicon glyphicon-btc"></i>  Fabricantes</a></li>        
 ...
 -->
        <li id="navProduct"><a href="solicitudes.php"> <i class="glyphicon glyphicon-ruble"></i> Solicitudes </a></li>     
<!-- 
        <li class="dropdown" id="navOrder">
          ...
          <ul class="dropdown-menu">            
            <li id="topNavAddOrder"><a href="orders.php?o=add"> <i class="glyphicon glyphicon-plus"></i> Agregar so</a></li>            
            <li id="topNavManageOrder"><a href="orders.php?o=manord"> <i class="glyphicon glyphicon-edit"></i> Gestionar Ordenes</a></li>            
          </ul>
        </li>  -->

        <li id="navReport"><a data-target="#addProductModal" href="modal/productModal.php"> <i class="glyphicon glyphicon-check"></i>Crear una solicitud </a></li>
